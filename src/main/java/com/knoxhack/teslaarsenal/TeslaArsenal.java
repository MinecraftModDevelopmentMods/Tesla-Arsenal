...
@Mod(modid = "teslaarsenal", name = "Tesla Arsenal", version = "1.5",dependencies = "required-after:Forge;after:modularity", updateJSON = "https://raw.githubusercontent.com/knoxhack/Tesla-Arsenal/master/update.json")
