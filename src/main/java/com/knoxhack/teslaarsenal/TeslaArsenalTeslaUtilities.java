...
public class TeslaArsenalTeslaUtilities
{
    ...
    public static ItemStack createChargedStack(ItemStack stack)
    {
        if(isPoweredItem(stack))
        {
            ...
            getContainer(chargedstack).setInputRate(TeslaArsenalTeslaUtilities.getMaxCapacity(stack));
            addPower(chargedstack, getMaxCapacity(stack));
            getContainer(chargedstack).setInputRate(TeslaArsenalTeslaUtilities.getMaxInput(stack));
            return chargedstack;
        }
        return null;
    }
