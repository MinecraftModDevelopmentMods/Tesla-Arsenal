...
public class BaseTeslaArsenalTeslaContainerProvider implements INBTSerializable<NBTTagCompound>, ICapabilityProvider
{
    ...
    public BaseTeslaArsenalTeslaContainerProvider(BaseTeslaContainer container, long maxCapacity, long input, long output)
    {
