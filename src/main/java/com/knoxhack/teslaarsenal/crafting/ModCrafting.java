...
public final class ModCrafting {
	...
	public static void initCrafting() {
		...
		GameRegistry.addRecipe(new ItemStack(TeslaArsenal.itemteslapickaxe, 1), new Object[] {"###", " I ", " I ", '#', TeslaArsenal.itemteslariumingot, 'I',TeslaArsenal.itemironstick});
		GameRegistry.addRecipe(new ItemStack(TeslaArsenal.itemteslaaxe, 1), new Object[] {"## ", "#I ", " I ", '#', TeslaArsenal.itemteslariumingot, 'I',TeslaArsenal.itemironstick});
		GameRegistry.addRecipe(new ItemStack(TeslaArsenal.itemteslashovel, 1), new Object[] {" # ", " I ", " I ", '#',TeslaArsenal.itemteslariumingot, 'I',TeslaArsenal.itemironstick});
		...
		GameRegistry.addRecipe(new ItemStack(TeslaArsenal.itemironstick, 1), new Object[] {"   ", " I ", " I ",'I', Items.IRON_INGOT});
