package com.knoxhack.teslaarsenal.tileentity;
...
public class TeslaArsenalContainer implements ITeslaConsumer, ITeslaProducer, ITeslaHolder, INBTSerializable<NBTTagCompound> {
     ...
     */
    public TeslaArsenalContainer(long capacity, long input, long output) {
     ...
     * @param output The maximum rate of power that can be extracted at a time.
     */
    public TeslaArsenalContainer(long power, long capacity, long input, long output) {
     ...
     */
    public TeslaArsenalContainer(NBTTagCompound dataTag) {
     ...
     */
    public TeslaArsenalContainer setCapacity (long capacity) {
     ...
     * @return The instance of the container being updated.
     */
    public TeslaArsenalContainer setInputRate (long rate) {
     ...
     * @return The instance of the container being updated.
     */
    public TeslaArsenalContainer setOutputRate (long rate) {
     ...
     * @return The instance of the container being updated.
     */
    public TeslaArsenalContainer setTransferRate (long rate) {
    ...
    public void generatePower () {
        ...
        this.stored += TeslaArsenalConfig.chargerPowerGen;
